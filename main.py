...
MODEL_COLUMNS = [
    ...
    'calculated_host_listings_count', 'availability_365', 'minimun_nights'
]
...
class Features(BaseModel):
    ...
    minimun_nights: int | None = Field(default=None, ge=1, le=365, description="Legacy compatibility field for the saved model")
...
def predict(features: Features):
    ...
    payload['minimun_nights'] = payload.get('minimun_nights') or payload['minimum_nights']
